...
<div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
        ...
        <div class="container" style="margin-top: 50px">
            ...
            <header id="header">
                <h5 style="font-weight: 600">학교현황</h5>
            </header>
            ...
            <form id="school_info" class="form-inline" method="POST">
                <table class="curriculum">
                    ...
                    <tr>
                        <td>현재 등록 된 이미지</td>
                        <td><img src="/img/count/<?=$file_name?>" style="max-width: 700px; min-width: 500px;"/></td>
                    </tr>
                    <tr class="c_text">
                        <td></td>
                ...
                <p style="text-align:center">
                    <button class="btn btn-green" type="button" onclick="Count_Modify_Swal(this)">저장</button>
                </p>
            </form>
        </div>
    </div>
