    ...
    <div id="page-content-wrapper">
        ...
        <div class="container" style="margin-top: 50px">
            ...
            <form id="board_notice" class="form-inline" name="fname" method="POST">
                ...
                <table class="intro">
                    ...
                    <tr>
                        <td>졸업기수</td>
                        <td><input type="text" id="title" name="title" class="form-control-file border" style="width: 10%;"/>&nbsp; 회</td>
                    </tr>
                    <tr>
                        <td>첨부파일</td>
                        <td>
        ...
        <script>
            Dropzone.options.dropzone = {
                url: '/admin/gallery/graduate_upload',
                ...
                complete:function(rs){
                    ...
                    if(rs['status'] == "success"){
                        ...
                        Swal.fire({title : '단일 이미지 업로드', text:'한장의 이미지만 등록 가능합니다.', icon: 'info'}).then((result) => { location.reload(); });
                    }else{
